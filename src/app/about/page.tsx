...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto">
      <AnimatedSection>
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">About Our Charity</h1>
      ...
      <AnimatedSection delay={0.8}>
        <div className="mt-8">
          <Link href="/volunteer" className="text-blue-600 dark:text-blue-400 hover:underline text-lg">
